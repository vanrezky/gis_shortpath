                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <form role="form" method="post" action="<?php echo base_url('petugas/aksi_petugas/get_route/' . $get_costumer_detail->id_costumer) ?>">
                                        <a href="<?= base_url('petugas/aksi_petugas/view_costumer') ?>" class="btn btn-danger btn-icon-split btn-sm">
