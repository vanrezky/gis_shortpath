          <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800"><?= $title ?> <?= $get_admin_detail->nama ?></h1>
                  ...
                  <div class="card-body">
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="ubah_nama">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('petugas/aksi_petugas/ubahnama/' . $get_admin_detail->id_user) ?>">
                      ...
                      <div class="tab-pane" id="ganti_password">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('petugas/aksi_petugas/change_password') ?>">
                          <div class="form-group row">
