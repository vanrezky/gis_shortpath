...
class Petugas extends MY_Controller {
  ...
  public function index() {
    ...
    {
      $data = array();
      $data['get_all_petugas']=$this->m_admin->get_all_petugas();

      $data['title']="Data Petugas";

            $this->render('admin/petugas_data', $data);

    	}
  else
    {
      redirect('admin/petugas/logout');
    }
  }
  ...
  public function edit($id)
  {
    ...
    if ($this->session->userdata('logged_in') != "" && $this->session->userdata('id_role') == "1") {
        ...
        helper_log("edit", "Edit Data Petugas ");
    ...
    if ($this->session->userdata('logged_in') != "" && $this->session->userdata('id_role') == "1") {
        ...
        if ($result) {
            ...
            helper_log("delete", "Delete Data Petugas");
    ...
    if ($this->session->userdata('logged_in') != "" && $this->session->userdata('id_role') == "1") {
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        redirect('admin/petugas/view/' . $id);
      } else {
